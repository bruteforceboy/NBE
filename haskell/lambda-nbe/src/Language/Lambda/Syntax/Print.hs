...
instance Print (Language.Lambda.Syntax.Abs.Program' a) where
  prt i = \case
    Language.Lambda.Syntax.Abs.AProgram _ terms -> prPrec i 0 (concatD [prt 0 terms])
...
instance Print (Language.Lambda.Syntax.Abs.ScopedTerm' a) where
  prt i = \case
    Language.Lambda.Syntax.Abs.AScopedTerm _ term -> prPrec i 0 (concatD [prt 0 term])

instance Print (Language.Lambda.Syntax.Abs.Pattern' a) where
  prt i = \case
    Language.Lambda.Syntax.Abs.PatternVar _ varident -> prPrec i 0 (concatD [prt 0 varident])
